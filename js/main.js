...
function coursePreviewVideo() {
    const coursePreviewModal =document.querySelector(".js-course-preveiw-modal")
    if(coursePreviewModal) {
        coursePreviewModal.addEventListener("shown-bs-modal", function() {
            this.querySelector(".js-course-preveiw-video").play();
            this.querySelector(".js-course-preveiw-video").currentTime = 0;
        });
        coursePreviewModal.addEventListener("hide-bs-modal", function(){
            this.querySelector(".js-course-preveiw-video").pause();
        })
    }
}
coursePreviewVideo();
...
function headerMenu() {
    ...
    menu.addEventListener("click", (event) => {
        ...
        if (
          ...
          window.innerWidth <= menuCollapseBreakpoint
              ...
              // prevent defauly anchor behavior
              ...
              //if not already expanded menu-item if exists
    ...
    window.addEventListener("resize", function() {
        if(this,this.innerWidth > menuCollapseBreakpoint && menu.classList.contains("open")){
            toggleMenu();
        }
        if(this,this.innerWidth > menuCollapseBreakpoint && menu.querySelector(".active")){
            collapse();
        }
    })
}
...
function themeGlassEffect(){
    const glassEffeCheckbox = document.querySelector('.js-glass-effect'),
    glassStyle = document.querySelector(".js-glass-style");

    glassEffeCheckbox.addEventListener("click", function() {
        if(this.checked){
    ...
    function glass() {
        ...
        if(glassStyle.hasAttribute("disabled")){
            glassEffeCheckbox.checked = true;
        }
    }
} 
themeGlassEffect()